...
fun main() {
    ...
    clubs.add(Club("Man United",20,12,6,3,1))
    clubs.add(Club("Chelsea",6,8,5,2,2))
    clubs.add(Club("Man City",9,7,8,1,0))
    ...
    for (club in clubs) {
        if (club.ucl == 0 && club.uel == 0)
            println("${club.name}")
    }
    println("==========================================================================================================================================================")
    // Panggil extension function Club recap
    println("Rekap Tim - Tim Liga Inggris:")
    for (club in clubs)
        println("- ${club.recap()}")
}
